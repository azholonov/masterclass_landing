...
export async function sendReceiptUploadEmail(input: {
  ...
  await transporter.sendMail({
    ...
    text: [
      `Здравствуйте, ${input.name}!`,
      "",
      "В связи со сбоями в работе Telegram-бота просим загрузить чек по персональной ссылке ниже.",
      "Если вы уже оплатили участие в мастер-классе, прикрепите фотографию или PDF-файл чека:",
    ...
    html: `
      <div style="font-family:Arial,sans-serif;line-height:1.6;color:#171717;max-width:600px">
        <h2>Уже оплатили?</h2>
        <p>Здравствуйте, ${escapeHtml(input.name)}!</p>
        <p>В связи со сбоями в работе Telegram-бота просим загрузить чек по персональной ссылке ниже.</p>
        <p>Если вы уже оплатили участие в мастер-классе, прикрепите фотографию или PDF-файл чека:</p>
